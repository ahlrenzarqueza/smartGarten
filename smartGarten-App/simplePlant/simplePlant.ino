...
int sunSetMin=0;
///////////////////////////////////////////////////////////////////////////////////////////////////////////
//FUNCTION FOR RUNNING A DNS SERVER ON THE ESP32 ,JUST PASS THE NAME OF THE HOST , TO BE CALLED AFTER Wifi.begin()
...
void setup() {
 ...
 digitalWrite(PIN_LED, LED_ON); // turn the LED on by making the voltage LOW to tell us we are in configuration mode.
  ...
  startedAt = millis();
  const char* hostname = "simpleplant";
...
//      WiFi.disconnect();
      ...
      Serial.println("Settin hostname");
      WiFi.setHostname("simpleplant");
      delay(300);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  mysensor1.attach(5,18);//Trigger pin , Echo pin
...
void handle_OnConnect() {
  ...
  Waterlevel=mysensor1.distanceInCm();
  PHValue=getPhValue();
  server.sendHeader("Access-Control-Allow-Origin", "*");
  server.sendHeader("Allow", "HEAD,GET,PUT,POST,DELETE,OPTIONS");
  server.sendHeader("Access-Control-Allow-Methods", "GET, HEAD, POST, PUT");
...
String SendHTML(float Temperaturestat,float Humiditystat, float Waterlevel, float PHValue){
